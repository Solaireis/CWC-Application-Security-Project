...
from wtforms import Form, validators, StringField, TextAreaField, EmailField, \
                    PasswordField, BooleanField, DecimalField, SelectField
...
class CreateLoginForm(Form):
    email = EmailField(
        "Email:", 
        [validators.Email(), validators.Length(min=5, max=254), validators.DataRequired()]
    )
...
class CreateCourse(Form):
    ...
    coursePrice = DecimalField(
        "Price for Course (USD$): ", 
